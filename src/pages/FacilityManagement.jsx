...
const FacilityManagement = () => {
    ...
    const handleSaveAndOpenEdit = () => {
        setShowModal(false);  // Close the Facility modal
                        ...
                        <div className="modal-content" style={{ width: "410px" }}>
                            ...
                            <div className="modal-footer">
                                ...
                                <button
                                    ...
                                    onClick={handleSaveAndOpenEdit}  // Open Edit Modal after saving
                                >
                                    Save
                                </button>
                            </div>
                    ...
                    <div className="modal-dialog modal-dialog-centered" role="document">
                        <div className="modal-content" style={{ width: "410px" }}>
                            ...
                            <div className="modal-footer">
                                ...
                                <button type="button" className="btn mainColor2" style={{  width: "175px", borderRadius:"10px" , height: "51px" ,fontSize:"18px", fontWeight:"500" }}>Save</button>
                            </div>
                        </div>
                    </div>
                </div>
