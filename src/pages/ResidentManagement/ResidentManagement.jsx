...
export default function Rm() {
 ...
 // Close create modal
  ...
  return (
    <div className="container-fluid d-flex flex-column flex-md-row main-content">
        ...
        <div className="container-fluid">
          <div className="bg-white residentmng">
            <div className="d-flex justify-content-between align-items-center">
              ...
              <button
                className="mainColor2 addresidentbtn ms-3 flex-end d-flex align-items-center p-2 border-0"
            ...
            >
              ...
              <Modal.Footer className="d-flex justify-content-between">
                <button
                  className="btn-secondary  font-weight-bold cancelbtn"
